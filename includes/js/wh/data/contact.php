...
// User settings
$to = "ansouphorn@gmail.com";
$subject = "Beng Ngim Contact";
...
if (empty($action)) {
	...
	<div class='contact-bottom'><a href='http://www.bengngim.110mb.com/'>Powered by Mr. Beng Ngim</a></div>
</div>";
	...
	if ($token === smcf_token($to)) {
		...
		sendMyMail($name, $email, $subject, $message, $cc);		
	}
	else {
...
function sendMyMail($name, $email, $subject, $message, $cc)
{
	global $to, $extra;
